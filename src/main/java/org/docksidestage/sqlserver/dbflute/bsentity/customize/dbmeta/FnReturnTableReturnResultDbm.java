...
public class FnReturnTableReturnResultDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((FnReturnTableReturnResult)et).getMemberId(), (et, vl) -> ((FnReturnTableReturnResult)et).setMemberId(cti(vl)), "memberId");
        setupEpg(_epgMap, et -> ((FnReturnTableReturnResult)et).getMemberName(), (et, vl) -> ((FnReturnTableReturnResult)et).setMemberName((String)vl), "memberName");
        setupEpg(_epgMap, et -> ((FnReturnTableReturnResult)et).getMemberStatusCode(), (et, vl) -> ((FnReturnTableReturnResult)et).setMemberStatusCode((String)vl), "memberStatusCode");
    }
    ...
    protected final String _tableDispName = "FnReturnTableReturnResult";
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlserver.dbflute.exentity.customize.FnReturnTableReturnResult"; }
    ...
    { doAcceptPrimaryKeyMap((FnReturnTableReturnResult)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((FnReturnTableReturnResult)et, mp); }
