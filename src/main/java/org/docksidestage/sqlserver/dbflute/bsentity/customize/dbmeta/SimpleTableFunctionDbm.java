...
public class SimpleTableFunctionDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((SimpleTableFunction)et).getMemberId(), (et, vl) -> ((SimpleTableFunction)et).setMemberId(cti(vl)), "memberId");
        setupEpg(_epgMap, et -> ((SimpleTableFunction)et).getMemberName(), (et, vl) -> ((SimpleTableFunction)et).setMemberName((String)vl), "memberName");
        setupEpg(_epgMap, et -> ((SimpleTableFunction)et).getMemberStatusCode(), (et, vl) -> ((SimpleTableFunction)et).setMemberStatusCode((String)vl), "memberStatusCode");
    }
    ...
    protected final String _tableDispName = "SimpleTableFunction";
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlserver.dbflute.exentity.customize.SimpleTableFunction"; }
