...
public class SpReturnResultSetNotParamResult1Dbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SpReturnResultSetNotParamResult1)et).getRegisterDatetime(), (et, vl) -> ((SpReturnResultSetNotParamResult1)et).setRegisterDatetime((java.sql.Timestamp)vl), "registerDatetime");
        ...
        setupEpg(_epgMap, et -> ((SpReturnResultSetNotParamResult1)et).getUpdateDatetime(), (et, vl) -> ((SpReturnResultSetNotParamResult1)et).setUpdateDatetime((java.sql.Timestamp)vl), "updateDatetime");
