...
public class VendorCheckDecimalSumDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnDecimalDigitSum = cci("DECIMAL_DIGIT_SUM", "DECIMAL_DIGIT_SUM", null, null, java.math.BigDecimal.class, "decimalDigitSum", null, false, false, false, "numeric", 38, 3, null, null, false, null, null, null, null, null, false);

    /**
     * DECIMAL_DIGIT_SUM: {numeric(38, 3)}
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlserver.dbflute.exentity.customize.VendorCheckDecimalSum"; }
