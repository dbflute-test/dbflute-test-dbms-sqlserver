...
public class MemberStatusDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnMemberStatusName = cci("MEMBER_STATUS_NAME", "MEMBER_STATUS_NAME", null, "会員ステータス名称", String.class, "memberStatusName", null, false, false, true, "nvarchar", 50, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnDescription = cci("DESCRIPTION", "DESCRIPTION", null, null, String.class, "description", null, false, false, true, "nvarchar", 200, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * (会員ステータス名称)MEMBER_STATUS_NAME: {NotNull, nvarchar(50)}
     * @return The information object of specified column. (NotNull)
     */
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlserver.dbflute.exentity.MemberStatus"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.sqlserver.dbflute.cbean.MemberStatusCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.sqlserver.dbflute.exbhv.MemberStatusBhv"; }
