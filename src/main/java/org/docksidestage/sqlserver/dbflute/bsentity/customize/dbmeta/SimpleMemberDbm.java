...
public class SimpleMemberDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SimpleMember)et).getBirthdate(), (et, vl) -> ((SimpleMember)et).setBirthdate(ctdt(vl)), "birthdate");
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlserver.dbflute.exentity.customize.SimpleMember"; }
