...
public class WhiteDelimiterDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((WhiteDelimiter)et).getDateDefault(), (et, vl) -> ((WhiteDelimiter)et).setDateDefault((java.sql.Timestamp)vl), "dateDefault");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlserver.dbflute.exentity.WhiteDelimiter"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.sqlserver.dbflute.cbean.WhiteDelimiterCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.sqlserver.dbflute.exbhv.WhiteDelimiterBhv"; }
