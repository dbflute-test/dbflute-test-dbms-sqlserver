...
/**
 * The entity of FnReturnTableReturnResult. <br>
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsFnReturnTableReturnResult extends AbstractEntity implements CustomizeEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsFnReturnTableReturnResult) {
            BsFnReturnTableReturnResult other = (BsFnReturnTableReturnResult)obj;
    ...
    @Override
    public FnReturnTableReturnResult clone() {
        return (FnReturnTableReturnResult)super.clone();
    }
