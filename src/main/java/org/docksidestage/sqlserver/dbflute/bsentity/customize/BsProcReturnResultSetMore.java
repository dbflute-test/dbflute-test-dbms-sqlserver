...
/**
 * The entity of ProcReturnResultSetMore. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsProcReturnResultSetMore extends AbstractEntity implements CustomizeEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsProcReturnResultSetMore) {
            BsProcReturnResultSetMore other = (BsProcReturnResultSetMore)obj;
    ...
    @Override
    public ProcReturnResultSetMore clone() {
        return (ProcReturnResultSetMore)super.clone();
    }
