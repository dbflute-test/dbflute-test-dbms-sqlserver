...
public abstract class BsWithdrawalReasonBhv extends AbstractBehaviorWritable<WithdrawalReason, WithdrawalReasonCB> {
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     * <span style="color: #70226C">if</span> (withdrawalReason != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<WithdrawalReason> withdrawalReasonList, SpecifyQuery<WithdrawalReasonCB> colCBLambda) {
        return doBatchUpdate(withdrawalReasonList, createSpecifiedUpdateOption(colCBLambda));
    }
