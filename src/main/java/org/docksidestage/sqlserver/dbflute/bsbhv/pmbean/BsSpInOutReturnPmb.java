...
/**
 * The base class for procedure parameter-bean of SpInOutReturn. <br>
 * This is related to "<span style="color: #AD4747">SP_IN_OUT_RETURN</span>".
 * @author DBFlute(AutoGenerator)
 */
public class BsSpInOutReturnPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SpInOutReturn. <br>
     * This is related to "<span style="color: #AD4747">SP_IN_OUT_RETURN</span>".
     */
    public BsSpInOutReturnPmb() {
    }
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "SP_IN_OUT_RETURN"; }
