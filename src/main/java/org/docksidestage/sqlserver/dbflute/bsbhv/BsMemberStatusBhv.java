...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable<MemberStatus, MemberStatusCB> {
     ...
     * memberStatusBhv.<span style="color: #CC4747">batchUpdate</span>(memberStatusList, new SpecifyQuery&lt;MemberStatusCB&gt;() {
     ...
     * <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">batchUpdate</span>(memberStatusList, new SpecifyQuery&lt;MemberStatusCB&gt;() {
