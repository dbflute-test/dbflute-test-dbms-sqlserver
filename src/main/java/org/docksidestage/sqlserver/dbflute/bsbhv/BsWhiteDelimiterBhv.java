...
public abstract class BsWhiteDelimiterBhv extends AbstractBehaviorWritable<WhiteDelimiter, WhiteDelimiterCB> {
     ...
     * <pre>
     * WhiteDelimiter whiteDelimiter = <span style="color: #0000C0">whiteDelimiterBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     * <span style="color: #70226C">if</span> (whiteDelimiter != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     *     ... = whiteDelimiter.get...();
     ...
     * WhiteDelimiterCB cb = <span style="color: #70226C">new</span> WhiteDelimiterCB();
     * cb.query().setFoo...(value);
     * WhiteDelimiter whiteDelimiter = <span style="color: #0000C0">whiteDelimiterBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb);
     * <span style="color: #70226C">if</span> (whiteDelimiter != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     *     ... = whiteDelimiter.get...();
     * } <span style="color: #70226C">else</span> {
     *     ...
     ...
     * whiteDelimiterBhv.<span style="color: #CC4747">batchUpdate</span>(whiteDelimiterList, <span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// the two only updated</span>
     *     <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     * });
     * <span style="color: #3F7E5E">// e.g. update every column in the table</span>
     * <span style="color: #0000C0">whiteDelimiterBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whiteDelimiterList, <span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<WhiteDelimiter> whiteDelimiterList, SpecifyQuery<WhiteDelimiterCB> colCBLambda) {
        return doBatchUpdate(whiteDelimiterList, createSpecifiedUpdateOption(colCBLambda));
    }
