...
/**
 * The base class for typed parameter-bean of ProcReturnResultSetMore. <br>
 * This is related to "<span style="color: #AD4747">various:vendorcheck:callProcReturnResultSetMore</span>" on VendorCheckBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsProcReturnResultSetMorePmb implements ListHandlingPmb<VendorCheckBhv, ProcReturnResultSetMore>, EntityHandlingPmb<VendorCheckBhv, ProcReturnResultSetMore>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of ProcReturnResultSetMore. <br>
     * This is related to "<span style="color: #AD4747">various:vendorcheck:callProcReturnResultSetMore</span>" on VendorCheckBhv.
     */
    public BsProcReturnResultSetMorePmb() {
    }
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "various:vendorcheck:callProcReturnResultSetMore"; }
