...
public abstract class BsProductBhv extends AbstractBehaviorWritable<Product, ProductCB> {
     ...
     * productBhv.<span style="color: #CC4747">batchUpdate</span>(productList, new SpecifyQuery&lt;ProductCB&gt;() {
     ...
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">batchUpdate</span>(productList, new SpecifyQuery&lt;ProductCB&gt;() {
     ...
     * <pre>
     * <span style="color: #3F7E5E">// e.g. update two columns only</span>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">batchUpdateNonstrict</span>(productList, new SpecifyQuery&lt;ProductCB&gt;() {
     *     public void specify(ProductCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     *         cb.specify().<span style="color: #CC4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *         cb.specify().<span style="color: #CC4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     }
