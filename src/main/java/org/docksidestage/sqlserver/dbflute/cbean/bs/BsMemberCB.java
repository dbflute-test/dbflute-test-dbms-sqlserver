...
import org.docksidestage.sqlserver.dbflute.cbean.nss.*;
...
public class BsMemberCB extends AbstractConditionBean {
     ...
     */
    public MemberAddressNss setupSelect_MemberAddressAsValid(final java.sql.Timestamp targetDate) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public MemberAddressCB.HpSpecification specifyMemberAddressAsValid(final java.sql.Timestamp targetDate) {
